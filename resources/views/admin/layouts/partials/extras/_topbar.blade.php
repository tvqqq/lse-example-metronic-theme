        ...
        @else
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('admin.layouts.partials.extras.dropdown._search-dropdown')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.notifications.display'))
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        @include('admin.layouts.partials.extras.dropdown._notifications')
                    </form>
                </div>
            </div>
        @endif
    ...
    @if (config('layout.extras.quick-actions.display'))
        ...
        @else
            <div class="dropdown">
                ...
                {{-- Dropdown --}}
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('admin.layouts.partials.extras.dropdown._quick-actions')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.cart.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    @include('admin.layouts.partials.extras.dropdown._cart')
                </form>
            </div>
        </div>
    @endif
    ...
    @if (config('layout.extras.languages.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                @include('admin.layouts.partials.extras.dropdown._languages')
            </div>
        </div>
    @endif
        ...
        @if (config('layout.extras.user.layout') == 'offcanvas')
            ...
            <div class="topbar-item">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <div class="btn btn-icon btn-clean btn-lg mr-1" data-toggle="tooltip" title="Logout" data-placement="bottom" onclick="event.preventDefault(); this.closest('form').submit();">
                        {{ Metronic::getSVG("media/svg/icons/Navigation/Sign-out.svg", "svg-icon-xl svg-icon-primary") }}
                     </div>
                </form>
            </div>
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    @include('admin.layouts.partials.extras.dropdown._user')
                </div>
            </div>
        @endif
    @endif
